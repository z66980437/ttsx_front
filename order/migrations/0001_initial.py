# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-12-01 06:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_SUCCESS', '成功'), ('PAYING', '待支付'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_FINISHED', '交易结束'), ('TRADE_CLOSE', '交易关闭')], default='PAYING', max_length=20, verbose_name='交易状态')),
