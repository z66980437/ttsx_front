...
class User(models.Model):
    ...
    balance = models.IntegerField(null=True, blank=True, verbose_name="账户余额")
    frozen_capital = models.IntegerField(null=True, blank=True, verbose_name="冻结资金")
    ico = models.ImageField(upload_to='goods/images/', null=True, blank=True, verbose_name='用户头像')
